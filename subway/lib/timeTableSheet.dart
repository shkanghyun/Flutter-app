      ...
      body: Stack(
        children: [
          ...
          PageView(
            ...
            children: [
              Container(color: Colors.amber, child: const Center(child: Text('첫 번째 페이지'))),
              Container(color: Colors.lightBlue, child: const Center(child: Text('두 번째 페이지'))),
              Container(color: Colors.green, child: const Center(child: Text('세 번째 페이지'))),
            ],
          ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    _pageController.previousPage(
                      duration: const Duration(milliseconds: 300), // 넘어가는 시간 (0.3초)
